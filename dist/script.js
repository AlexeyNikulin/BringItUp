    ...
    value: function init() {
      ...
      this.forms.forEach(function (item) {
        item.addEventListener('submit', function (e) {
          ...
          statusMessage.textContent = _this.mesage.loading;
          item.parentNode.append(statusMessage);
          var formData = new FormData(item);

          _this.postData(_this.path, formData).then(function (res) {
            console.log(res);
            statusMessage.textContent = _this.mesage.success;
          }).catch(function (e) {
            statusMessage.textContent = _this.mesage.failure;
          }).finally(function () {
            item.reset();
            setTimeout(function () {
...
function (_Slider) {
  ...
  function MiniSlider(container, next, prev, activeClass, autoplay, animate) {
    _classCallCheck(this, MiniSlider);

    return _possibleConstructorReturn(this, _getPrototypeOf(MiniSlider).call(this, container, next, prev, activeClass, autoplay, animate));
  }
  ...
  _createClass(MiniSlider, [{
    ...
    value: function bindTriggers() {
      ...
      this.prev.addEventListener('click', function () {
        var active = _this2.slides[_this2.slides.length - i];
      ...
      if (this.autoplay) {
        var timeAutoSlide;
        timeAutoSlide = setInterval(function () {
          return _this2.nextSlide(i);
        }, 3000);
